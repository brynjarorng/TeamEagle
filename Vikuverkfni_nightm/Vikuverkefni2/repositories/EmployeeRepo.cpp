...
void EmployeeRepo::rewrite(const Employee& e) {

    int tell = month_position(e);
...
string EmployeeRepo::year_write_format(const Employee& e) {
...
bool EmployeeRepo::first_instance(const string& input, const string& file, int pos) {
...
string EmployeeRepo::id_write_format(const Employee& e) {
...
vector<string> EmployeeRepo::open_by_year(const string &year) {
...
vector<string> EmployeeRepo::open_by_SSN(const string& SSN) {
